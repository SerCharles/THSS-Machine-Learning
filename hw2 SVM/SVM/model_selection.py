...
if __name__ == "__main__":
    ...
    best_loss_train_list, best_loss_eval_list, best_acc_train_list, best_acc_eval_list, best_loss_test, best_acc_test = grid_search(args.type)
